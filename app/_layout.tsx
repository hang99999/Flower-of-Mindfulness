  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      <Stack screenOptions={{
        ...
        <Stack.Screen name="p-audio_play" options={{ title: "音频播放页" }} />
        <Stack.Screen name="p-record_edit" options={{ title: "记录编辑页" }} />
        <Stack.Screen name="p-settings" options={{ title: "设置页" }} />
        <Stack.Screen name="p-reminder_settings" options={{ title: "提醒设置页" }} />
      </Stack>
